...
class TwitterClient(object):
    ...
    def __init__(self, query, retweets_only=False, with_sentiment=False):
        ...
        consumer_key = 'wnmjMUFox7NaTSxQuV4Kw9pYx'
        consumer_secret = 'QcE6STQ15EortIWYzF1ruVtiWTPOVSy8SLJ0p6lNhF3mUBKyuH'
        access_token = '784387434771419136-dMegv84RBexpLlgAM9PBSfI9YXfGQ05'
        access_token_secret = '8vDveUeGZ7cMaJ8h3oSMknB6GxQNVaYEcLZxaUD0SLsv1'
    ...
    def get_tweets(self):
        ...
        try:
            recd_tweets = self.api.search(q=self.query,lang = "en",count=self.tweet_count_max)
            if not recd_tweets:
                pass
